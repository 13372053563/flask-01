...
from blue_prints.detect.utils.general import bbox_iou, bbox_alpha_iou, box_iou, box_giou, box_diou, box_ciou, xywh2xyxy
from blue_prints.detect.utils.torch_utils import is_parallel
...
class ComputeLossOTA:
    ...
    def build_targets(self, p, targets, imgs):
        ...
        for batch_idx in range(p[0].shape[0]):
            ...
            pair_wise_iou = box_ciou(txyxy, pxyxys)
